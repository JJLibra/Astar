...
AboutDialog::AboutDialog(QWidget *parent){
    //窗口
    this->setWindowTitle("星G611的ikuns");
    this->setWindowIcon(QIcon(":/img/nwpu.png"));
    ...
    text6->setText("<a style='color:#3cbdff;' href=\"https://space.bilibili.com/1327183873?spm_id_from=333.1007.0.0\">Bilibili:Rosssyyyy");
